    ...
    if($_GET['m']=='1'){
        if(isset($_POST['simpan'])){
            if(tambahgtk($_POST)>0){
                echo "<script>
                    $(function() {
                        toastr.success('Data GTK Berhasil Disimpan!','Terima Kasih'
                        {
                            timeOut:1000,
                            fadeOut:1000,
                            onHidden: function(){
        ...
        if(isset($_POST['simpan'])){
            if(updategtk($_POST)>0){
                echo "<script>
                    $(function() {
                        toastr.success('Data GTK Berhasil Diupdate!','Terima Kasih', {
                            timeOut:1000,
                            fadeOut:1000,
                            onHidden: function(){
                                window.location.href='index.php?p=datagtk';
                ...
                echo "<script>
                        $(function() {
                            toastr.error('Data GTK Gagal Diupdate!','Mohon Maaf',{
                                timeOut:1000,
                                fadeOut:1000,
                                onHidden:function(){
                                    window.location.href='index.php?p=datagtk';
