...
class PDF extends FPDF
{
    ...
    function IsiSurat()
    {
        $this->SetXY(2.0, 4.5);
        $this->SetFont('Times', 'B', 12);
        $this->Cell(17.5, 0.575, 'SURAT KETERANGAN PINDAH SEKOLAH', 0, 0, 'C');
        $this->Ln();
        ...
        $this->Cell(5.5, 0.575, 'Nomor Induk / N I S N');
        $this->Cell(0.25, 0.575, ':');
        $this->Ln();
        $this->Cell(0.75, 0.575);
        ...
        $this->Cell(5.5, 0.575, 'Kelas');
        $this->Cell(0.25, 0.575, ':');
        $this->Ln();
        $this->Cell(0.75, 0.575);
        $this->Cell(0.75, 0.575, '6.');
        $this->Cell(5.5, 0.575, 'Nama Orang Tua');
        $this->Cell(0.25, 0.575, '');
        $this->Ln();
        $this->Cell(1.5, 0.575);
        $this->Cell(0.5, 0.575, 'a.');
        $this->Cell(5.0, 0.575, 'Ayah');
        $this->Cell(0.25, 0.575, ':');
        $this->Ln();
        $this->Cell(1.5, 0.575);
        $this->Cell(0.5, 0.575, 'b.');
        $this->Cell(5.0, 0.575, 'Ibu');
        $this->Cell(0.25, 0.575, ':');
        $this->Ln();
        $this->Cell(0.75, 0.575);
        $this->Cell(0.75, 0.575, '7.');
        $this->Cell(5.5, 0.575, 'Pekerjaan OrangTua');
        $this->Cell(0.25, 0.575, '');
        $this->Ln();
        $this->Cell(1.5, 0.575);
        $this->Cell(0.5, 0.575, 'a.');
        ...
        $this->Cell(5.5, 0.575, 'Alamat Peserta Didik');
        $this->Cell(0.25, 0.575, ':');
        $this->Ln();
        $this->MultiCell(19.0, 0.575, 'Berdasarkan permintaan tertulis dari orang tua / wali yang bersangkutan telah mengajukan pindah ke:', 0, 'J');
        $this->Cell(0.75, 0.575);
        $this->Cell(0.75, 0.575, '8.');
        $this->Cell(5.5, 0.575, 'Mutasi Dari');
        $this->Cell(0.25, 0.575, '');
        $this->Ln();
        $this->Cell(1.5, 0.575);
        $this->Cell(0.5, 0.575, 'a.');
        $this->Cell(5.0, 0.575, 'Kelas');
        $this->Cell(0.25, 0.575, ':');
        $this->Ln();
        $this->Cell(1.5, 0.575);
        $this->Cell(0.5, 0.575, 'b.');
        $this->Cell(5.0, 0.575, 'Nama Satuan Pendidikan');
        $this->Cell(0.25, 0.575, ':');
        $this->Ln();
        $this->Cell(1.5, 0.575);
        $this->Cell(0.5, 0.575, 'c.');
        $this->Cell(5.0, 0.575, 'NPSN');
        $this->Cell(0.25, 0.575, ':');
        $this->Ln();
        $this->Cell(1.5, 0.575);
        $this->Cell(0.5, 0.575, 'c.');
        $this->Cell(5.0, 0.575, 'Alamat Satuan Pendidikan');
        $this->Cell(0.25, 0.575, ':');
        $this->Ln(0.74);
        $this->MultiCell(19, 0.575, 'Demikian surat keterangan ini dibuat dan diberikan kepada yang bersangkutan, untuk dapat dipergunakan sebagaimana mestinya.
		', 0, 'J');
    }
