			...
			<div class="card-body">
				<div class="row form-group">
					<div class="col-sm-2 text-center mb-5">
						<img class="img-fluid img-thumbnail rounded" src="assets/img/avatar.gif" width="160px" id="fotosiswa">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group row mb-2" for="nmsiswa">
									...
									<div class="col-sm-6">
										...
										<input class="form-control form-control-sm" name="nmsiswa" id="nmsiswa"><!--required oninvalid="this.setCustomValidity('Nama Wajib Diisi!')" oninput="setCustomValidity('')">-->
									</div>
								</div>
								<div class="form-group row mb-2" for="nik">
									<label class="col-sm-5 offset-sm-1">N I K</label>
									<div class="col-sm-6">
										<input class="form-control form-control-sm" name="nik" id="nik" onkeyup="validAngka(this)"><!-- required oninvalid="this.setCustomValidity('Kolom NIK Wajib Diisi')" oninput="setCustomValidity('')"> -->
									</div>
								</div>
								<div class="form-group row mb-2" for="nis">
									<label class="col-sm-5 offset-sm-1" for="nis">N I S</label>
									<div class="col-sm-6">
										<input class="form-control form-control-sm" name="nis" id="nis"><!--required oninvalid="this.setCustomValidity('N I S Wajib Diisi')" oninput="setCustomValidity('')">-->
									</div>
								</div>
								...
								<div class="form-group row mb-2" for="anake">
									...
									<div class="col-sm-3 mb-2">
										<input class="form-control form-control-sm" name="anake" id="anake" placeholder='anak ke' value="<?php echo $anake;?>">
									</div>
									<div class="col-sm-3" for="saudara">
										<input class="form-control form-control-sm" name="saudara" id="saudara" placeholder="bersaudara" value="<?php echo $sdr;?>">
									</div>
								</div>
							...
							<div class="col-sm-6">							
								<div class="form-group row mb-2" for="jarak">
									...
									<div class="col-sm-3 mb-2">
										<input max="25" class="form-control form-control-sm" name="jarak" id="jarak" placeholder="berapa km">
									</div>
									<div class="col-sm-3 mb-2" for="waktu">
										<input class="form-control form-control-sm" name="waktu" id="waktu" placeholder="menit">
									</div>
								</div>
								...
								<div class="form-group row mb-2" for="olahrg">
									...
									<div class="col-sm-6">
										<input class="form-control form-control-sm" name="olahrg" id="olahrg" placeholder="Bidang Olahraga">
									</div>
								</div>
								<div class="form-group row mb-2" for="seni">
									<label class="col-sm-5 offset-sm-1"></label>
									<div class="col-sm-6">
										<input class="form-control form-control-sm" name="seni" id="seni" placeholder="Bidang Seni">
									</div>
								</div>
								<div class="form-group row mb-2" for="orgns">
									<label class="col-sm-5 offset-sm-1"></label>
									<div class="col-sm-6">
										<input class="form-control form-control-sm" name="orgns" id="orgns" placeholder="Kemasyarakatan/Organisasi">
									</div>
								</div>
								<div class="form-group row mb-2" for="lain">
									<label class="col-sm-5 offset-sm-1"></label>
									<div class="col-sm-6">
										<input class="form-control form-control-sm" name="lain" id="lain" placeholder="Hobi Lainnya">
									</div>
								</div>
								<div class="form-group row mb-2">
