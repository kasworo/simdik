            ...
            ?>
                <tr>
                    ...
                    <td style="vertical-align: middle;">
                        <input class="form-control" type="hidden" name="mapel[]" id="mapel<?php echo $no; ?>" style="text-align:center;height:42px" value="<?php echo $mp['idmapel']; ?>">
                        <input class="form-control txtNilai" type="number" name="nilai[]" id="nilai<?php echo $no; ?>" style="text-align:center;height:42px" value="<?php echo $dn['nilairapor']; ?>" disabled>
                    </td>
                    <td style="vertical-align: middle;">
                        <select class="form-control txtPredikat" type="text" name="predikat[]" id="nilai<?php echo $no; ?>" style="height:42px" disabled>
                    ...
                    <td style="vertical-align: middle;">
                        <textarea class="form-control txtDeskripsi" name="deskripsi[]" id="des<?php echo $no; ?>" rows="2" disabled><?php echo $dn['deskripsi']; ?></textarea>
                    </td>
                </tr>
            <?php endforeach ?>
        </tbody>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $teks; ?></td>
                        <td style="vertical-align: middle;">
                            <input class="form-control" type="hidden" name="aspek[]" id="aspek<?php echo $i; ?>" style="text-align:center;height:42px" value="<?php echo $i; ?>">
                            <select class="form-control txtPredikat" type="text" name="nilai[]" id="nilai<?php echo $i; ?>" style="height:42px" disabled>
                                <option value="">..Pilih..</option>
                        ...
                        <td>
                            <textarea class="form-control txtDeskripsi" name="deskripsi[]" id="deskripsi<?php echo $i; ?>" rows="2" disabled><?php echo $ds['deskripsi']; ?></textarea>
                        </td>
                    </tr>
                <?php endfor ?>
            </tbody>
