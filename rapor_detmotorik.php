...
<div class="alert alert-warning">
	...
	<p>Tabel di bawah ini merupakan nilai dan predikat Penilaian Keterampilan yang diperoleh tiap semester.
	</p>
</div>
<div class="card card-primary card-outline">
	<div class="card-header">
		<h5 class="card-title m-0">Detail Nilai Keterampilan Untuk <?php echo $namasiswa;?></h5>
	</div>
	<div class="card-body">
