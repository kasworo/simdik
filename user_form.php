<div class="alert alert-warning">
	<p>
		...
		<br />Silahkan cek kembali data anda, lengkapi dan betulkan jika masih terdapat data
		yang masih kurang atau salah, kemudian klik tombol <strong>Update</strong>
	</p>
</div>
					...
					<div class="row">
						<div class="col-sm-6">
							...
							<div class="row" style="padding-bottom:5px">
								...
								<div class="col-sm-6">
									<input class="form-control" name="nip" id="nip" value="<?php echo $nip;?>"
...
$(function() {
	...
	new AjaxUpload(btnUpload, {
		...
		onComplete: function(file, response) {
			status.text('');
			if (response === "success") {
				$('#fotouser').html('<img src="foto/' + file + '" height="180px" alt="" />')
					.addClass('success');
		...
		$("#simpan").click(function() {
			...
			if (nmuser == "" || nmuser == null) {
				...
				$.ajax({
					type: "POST",
					url: "user_simpan.php",
					data: "aksi=simpan&id=" + username + "&nama=" + nmuser + "&nip=" +
						nip + "&tmplahir=" + tmplahir + "&tgllahir=" + tgllahir +
						"&gender=" + gender + "&agama=" + agama + "&jbtd=" + jbtdinas +
						"&jbtp=" + jbtpanitia + "&email=" + email + "&almt=" + almt +
						"&desa=" + desa + "&kec=" + kec + "&kab=" + kab + "&prov=" +
						prov + "&kdpos=" + kdpos + "&nohp=" + nohp,
