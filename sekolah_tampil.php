				...
				<div class="row mb-2">
					...
					<div class="col-sm-9">
						<div class="row mb-2">
							...
							<input type="text" class="form-control col-sm-5" id="kode" name="kode" placeholder="Kode Satuan Pendidikan" value="<?php echo $sk['kdskul'];?>">
						</div>
						<div class="row mb-2">
							<label class="col-sm-5 offset-sm-1">Nama Satuan Pendidikan</label>
							<input type="text" class="form-control col-sm-5" id="nama" name="nama" placeholder="Nama Satuan Pendidikan" value="<?php echo $sk['nmskul'];?>">
						</div>
						<div class="row mb-2">
							<label class="col-sm-5 offset-sm-1">NPSN</label>
							<input type="text" class="form-control col-sm-5" id="npsn" name="npsn" placeholder="N P S N" value="<?php echo $sk['npsn'];?>">
						</div>
						<div class="row mb-2">
							<label class="col-sm-5 offset-sm-1">No. Statistik Sekolah</label>
							<input type="text" class="form-control col-sm-5" id="nss" name="nss" placeholder="Nomor Statistik Sekolah" value="<?php echo $sk['nss'];?>">
						</div>
						<div class="row mb-2">
							<label class="col-sm-5 offset-sm-1">Nama SKPD</label>
							<input type="text" class="form-control col-sm-5" id="skpd" name="skpd" placeholder="Nama SKPD atau Yayasan" value="<?php echo $sk['nmskpd'];?>">
						</div>
						<div class="row mb-2">
							<label class="col-sm-5 offset-sm-1">Alamat</label>
							<input type="text" class="form-control col-sm-5" id="almt" name="almt" placeholder="Alamat" value="<?php echo $sk['alamat'];?>">
						</div>
						<div class="row mb-2">
							<label class="col-sm-5 offset-sm-1">Desa</label>
							<input type="text" class="form-control col-sm-5" id="desa" name="desa" placeholder="Desa" value="<?php echo $sk['desa'];?>">
						</div>
						<div class="row mb-2">
							<label class="col-sm-5 offset-sm-1">Kecamatan</label>
							<input type="text" class="form-control col-sm-5" id="kec" name="kec" placeholder="Kecamatan" value="<?php echo $sk['kec'];?>">
						</div>
						<div class="row mb-2">
							<label class="col-sm-5 offset-sm-1">Kabupaten</label>
							<input type="text" class="form-control col-sm-5" id="kab" name="kab" placeholder="Kabupaten" value="<?php echo $sk['kab'];?>">
						</div>
						<div class="row mb-2">
							<label class="col-sm-5 offset-sm-1">Provinsi</label>
							<input type="text" class="form-control col-sm-5" id="prov" name="prov" placeholder="Provinsi" value="<?php echo $sk['prov'];?>">
						</div>
						<div class="row mb-2">
							<label class="col-sm-5 offset-sm-1">Kode Pos</label>
							<input type="text" class="form-control col-sm-5" id="kdpos" name="kdpos" placeholder="Kode Pos" value="<?php echo $sk['kdpos'];?>">
						</div>
						<div class="row mb-2">
							<label class="col-sm-5 offset-sm-1">Website</label>
							<input type="text" class="form-control col-sm-5" id="web" name="web" placeholder="Website Satuan Pendidikan" value="<?php echo $sk['website'];?>">
						</div>
						<div class="row mb-2">
							<label class="col-sm-5 offset-sm-1">E-mail</label>
							<input type="text" class="form-control col-sm-5" id="imel" name="imel" placeholder="Email Satuan Pendidikan" value="<?php echo $sk['email'];?>">
						</div>
					</div>
				</div>
			</div>
