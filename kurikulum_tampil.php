	...
	<div class="card card-secondary card-outline">
		<div class="card-header">
			...
			<div class="card-tools">
			  <button class="btn btn-flat btn-success btn-sm" id="btnTambah" data-toggle="modal" data-target="#myAddKurikulum">
			  ...
			  <table id="tb_kurikulum" class="table table-bordered table-striped table-sm">
				...
				<tr>
				  ...
				  <td style="text-align: center">
					<a href="#myAddKurikulum" data-toggle="modal" data-id="<?php echo $m['idkur'];?>" class="btn btn-xs btn-success btn-flat btnUpdate">
