					...
					<div class="card card-info card-outline">
						...
						<div class="card-body">
							<div class="form-group mb-2">
								...
								<p>
									Klik tombol <strong>Download</strong> untuk mengunduh file template data peserta didik.<br/>
						...
						<div class="card-footer justify-content-between">
							<form method="POST" enctype="multipart/form-data" action="">
								<input type="file" class="col-sm-7" name="filepd">
					...
					<div class="card card-primary card-outline">
						...
						<div class="card-body">
							<div class="form-group mb-2">
								<p><strong>Petunjuk:</strong></p>
								<p>
									Klik tombol <strong>Download</strong> untuk mengunduh file template data ayah kandung.<br/>
									Editlah kemudian Upload ke database melalui tool di bawah ini.
								</p>
                 			</div>
						</div>
						<div class="card-footer justify-content-between">
							<form method="POST" enctype="multipart/form-data" action="">
								<input type="file" class="col-sm-7" name="fileayah">
								<input type="hidden" name="nmfile" value="1">
								<button type="submit" class="btn btn-primary btn-sm ml-2" name="tmpayah">
									<i class="fas fa-cloud-upload-alt"></i>&nbsp;Upload
								</button>
								<a href="siswa_template.php?d=2" class="btn btn-sm btn-success ml-2">
								<i class="fas fa-cloud-download-alt"></i>&nbsp;Download
							</a>
							</form>							
						</div>
					...
					<div class="card card-secondary card-outline">
						...
						<div class="card-body">
							<div class="form-group mb-2">
								<p><strong>Petunjuk:</strong></p>
								<p>
									Klik tombol <strong>Download</strong> untuk mengunduh file template data ibu kandung.<br/>
									Editlah kemudian Upload ke database melalui tool di bawah ini.
								</p>
                 			</div>
						</div>
						<div class="card-footer justify-content-between">
							<form method="POST" enctype="multipart/form-data" action="">
								<input type="file" class="col-sm-7" name="fileibu">
				...
				<div class="col-sm-6">
					<div class="card card-danger card-outline">
						...
						<div class="card-body">
							...
							<p><strong>Petunjuk:</strong></p>
								<p>
									Klik tombol <strong>Download</strong> untuk mengunduh file template data wali.<br/>
									Editlah kemudian Upload ke database melalui tool di bawah ini.
								</p>
                 			</div>
						</div>
						<div class="card-footer justify-content-between">
							<form method="POST" enctype="multipart/form-data" action="">
								<input type="file" class="col-sm-7" name="filewali">
