					...
					<tbody>
						...
						<tr>
							...
							<td style="text-align:center">
								<button data-id="<?php echo $tp['kdthpel'];?>" class="btn btn-default btn-sm btn-flat col-sm-5 btnBiodata">
									<i class="fas fa-print"></i>&nbsp;Biodata
								</button>
								<button data-id="<?php echo $tp['kdthpel'];?>" class="btn btn-default btn-sm btn-flat col-sm-5 btnNilai">
