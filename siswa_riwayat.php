<?php
	...
	if(isset($_POST['simpan'])){
		$sql="SELECT*FROM tbriwayatskul WHERE idsiswa='$idsiswa'";
		if(ceksiswa($sql)==0){
			if(addriwayat($_POST)>0){
				echo "<script>
						$(function() {
				...
				<div class="row mt-auto">
					<div class="col-sm-6">
						<div class="form-group row mb-2">
							<input type="hidden" class="form-control form-control-sm col-sm-6" name="idsiswa" id="idsiwa" value="<?php echo $idsiswa;?>">			
