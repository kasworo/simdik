<div class="col-sm-12">
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h5 class="card-title m-0">Input Nilai Sikap Spiritual dan Sosial</h5>
                    ...
                    <table class="table table-bordered table-condensed table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input class="form-control txtNilai" name="nilai" id="spiritual"
                                        style="text-align:center;height:42px">
                                </td>
                                <td>
                                    <textarea class="form-control txtDeskripsi" name="" id="des_spiritual"
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="form-control txtNilai" name="nilai" id="sosial"
                                        style="text-align:center;height:42px">
                                </td>
                                <td>
                                    <textarea class="form-control txtDeskripsi" name="" id="des_sosial"
                                        style="height:42px"></textarea>
                                </td>
                            </tr>
                        </tbody>
