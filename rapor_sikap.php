...
if (isset($_POST['sikap'])) {
    $rows = isset($_POST['aspek']) ? $_POST['aspek'] : 1;
    $i = 0;
    $gagal = 0;
    $tambah = 0;
    $edit = 0;
    ...
    foreach ($rows as $row) {
        ...
        $ceknilai = cekdata('tbnilaisikap', $key);
        if ($ceknilai > 0) {
            $nilai = array(
                'nilaisikap' => $_POST['nilai'][$i],
                'deskripsi' => $_POST['deskripsi'][$i]
            );
            $editnilai = editdata('tbnilaisikap', $nilai, '', $key);
            if ($editnilai > 0) {
                $edit++;
            } else {
                $batal++;
            ...
            $tambahnilai = adddata('tbnilaisikap', $nilai);
            if ($tambahnilai > 0) {
                $tambah++;
            } else {
                $gagal++;
...
<div class="card card-primary card-outline">
    <div class="card-header">
        <h5 class="card-title m-0" id="judul">Input Nilai Sikap Spiritual dan Sosial</h5>
        <div class="card-tools">
            <a href="index.php?p=datarapor&d=1" class="btn btn-tool">
        ...
        <div class="card-body">
            ...
            <div class="form-group row mt-2 mb-4">
                ...
                <div class="col-sm-3">
                    ...
                    <button type="submit" class="btn btn-info col-6 mt-0 ml-2" id="simpan" name="sikap">
                        <i class="fas fa-save">
                        </i>
                        Simpan</button>
                </div>
