...
<body class="hold-transition login-page" style="background:url(assets/img/boxed-bg.png)">
		...
		<div class="card">
			<div class="card-body register-card-body">
				...
				<form action="" method="post" role="form" id="FrmRegistrasi">
					...
					<div class="form-group mb-3">
						<div class="input-group">
							<input type="password" class="form-control" name="paswd" id="paswd" placeholder="Password" autocomplete="off">
							<div class="input-group-append">
								<div class="input-group-text">
					...
					<div class="form-group mb-5">
						<div class="input-group">
							<input type="password" class="form-control" name="conf" id="conf" placeholder="Password" autocomplete="off">
							<div class="input-group-append">
								<div class="input-group-text">
									<span class="fas fa-key"></span>
								</div>
	...
	<div class="login-box">
		<div class="login-logo">
			<b>Aplikasi SIMAK</b><br/><p style="font-size:16pt">(Sistem Informasi Akademik)</p>
		</div>
