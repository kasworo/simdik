    ...
    if (isset($_POST['simpan'])) {
        if ($_POST['idmapel'] == '') {
            $data = array(
                ...
                'akmapel' => $_POST['akmapel']
            );
            $rows = adddata('tbmapel', $data);
            if ($rows > 0) {
                echo "<script>
							$(function() {
            ...
            $field = array('idmapel' => $_POST['idmapel']);
            $rows = editdata('tbmapel', $data, $field);
            if ($rows > 0) {
                echo "<script>
							$(function() {
            ...
            <div class="modal-content">
                ...
                <form action="" method="post">
                    <div class="modal-body">
                        <div class="col-sm-12">
                            <input type="hidden" class="form-control form-control-sm form-control form-control-sm-sm" id="idmapel" name="idmapel">
                            <div class="form-group row mb-2">
                                <label class="col-sm-4">Kurikulum</label>
                                <select class="col-sm-6 form-control form-control-sm form-control form-control-sm-sm" id="idkur" name="idkur">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <input type="text" class="col-sm-6 form-control form-control-sm form-control form-control-sm-sm" id="nmmapel" name="nmmapel">
                            </div>
                            <div class="form-group row mb-2">
                                <label class="col-sm-4">Kode</label>
                                <input type="text" class="col-sm-6 form-control form-control-sm form-control form-control-sm-sm" id="akmapel" name="akmapel">
                            </div>
                        </div>
                    </div>
