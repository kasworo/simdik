		...
		<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
				...
				<ul class="nav nav-treeview">
					...
					<li class="nav-item has-treeview">
						...
						<ul class="nav nav-treeview">
							...
							<li class="nav-item">
								<a href="index.php?p=dropout" class="nav-link">
									<i class="fas fa-user-minus nav-icon"></i>
									<p>Drop Out</p>
								</a>
							</li>
				...
				<ul class="nav nav-treeview">
					<li class="nav-item has-treeview">
						...
						<ul class="nav nav-treeview">
							...
							<li class="nav-item">
								<a href="index.php?p=raporekskul" class="nav-link">
									<i class="far fa-check-square nav-icon"></i>
									<p>Nilai Ekstrakurikuler</p>
								</a>
							</li>
							<li class="nav-item">
								<a href="index.php?p=absenrapor" class="nav-link">
									<i class="fas fa-check nav-icon"></i>
									<p>Ketidakhadiran</p>
								</a>
							</li>
							<li class="nav-item">
								<a href="index.php?p=catatanrapor" class="nav-link">
									<i class="fas fa-list nav-icon"></i>
									<p>Keputusan Akhir Tahun</p>
								</a>
							</li>
						</ul>
					</li>
			...
			<li class="nav-item has-treeview">
				...
				<ul class="nav nav-treeview">
					...
					<li class="nav-item">
						<a href="#" class="nav-link linkModal" data-toggle="modal" data-target="#myReport" data-id="klapper">
