<?php
	...
	if(isset($_POST['simpan'])){
		$sql="SELECT*FROM tbortu WHERE hubkel='$_POST[hubkel]' AND idsiswa='$_POST[idsiswa]'";
		if(ceksiswa($sql)==0){
			if(addortu($_POST)>0){
				echo "<script>
						$(function() {
	...
	<div class="card card-primary card-outline">
		...
		<form action="" method="post">
			...
			<div class="card-footer">
				<div class="row">
					<a href="index.php?p=addriwayat&id=<?php echo $idsiswa;?>" class="btn btn-md btn-danger mb-2 ml-2 col-sm-2">
					...
					<a href="index.php?p=addibu&id=<?php echo $idsiswa;?>&j=2" class="btn btn-success btn-md mb-2 ml-2 col-sm-2">
