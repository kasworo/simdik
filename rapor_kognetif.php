		...
		<div class="card-body">
			...
			<div class="form-group row mt-2 mb-4">
				<div class="col-sm-3">
					...
					<select class="form-control form-control-sm input-sm" id="txtKls" onchange="getthpel(this.value)">
						<option value=""> ..Pilih.. </option>
						<?php
						$sqlk = "SELECT idkelas, nmkelas FROM tbkelas INNER JOIN tbskul USING(idjenjang)";
						$qkls = vquery($sqlk);
						foreach ($qkls as $kl) :
						?>
