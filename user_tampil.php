			...
			<form method="POST" action="user_tukar.php">
				...
				<div class="modal-body">
					<div class="form-group row mb-2">
						...
						<select class="form-control form-control-sm col-sm-6" id="setlev" name="setlev" onchange="getlev(this.value)">
					...
					<div class="form-group row mb-2">
						...
						<select class="form-control form-control-sm col-sm-6" id="setname" onchange="getname(this.value)" disabled>	
							<option value="">..Pilih..</option>					
						</select>					
					</div>
					<div class="form-group row mb-2">
