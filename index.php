					...
					<div class="container-fluid">
						<div class="form-group">
							...
							if ($level == '1') {
								switch ($_GET['p']) {
									case 'refpddk': {
											include "refpddk_tampil.php";
											break;
										}
									case 'refkerja': {
											include "refkerja_tampil.php";
											break;
										}
									case 'refskul': {
											include "refskul_tampil.php";
											break;
										}
									case 'dashboard': {
									...
									case 'addayah': {
											include "siswa_ayah.php";
											break;
										}
									case 'addibu': {
											include "siswa_ibu.php";
											break;
										}
									case 'addwali': {
											include "siswa_wali.php";
											break;
										}
									case 'eksporsiswa': {
											include "siswa_ekspor.php";
											break;
										}
									case 'addrombel': {
											include "form_rombel.php";
											break;
										}
									case 'regsiswa': {
											include "siswa_registrasi.php";
											break;
										}
									case 'asalsd': {
											include "siswa_asalsd.php";
											break;
										}
									case 'mutasi': {
											include "siswa_mutasi.php";
											break;
										}
									case 'dropout': {
											include "siswa_dropout.php";
											break;
										}
									case 'akhir': {
											include "siswa_lulus.php";
											break;
										}

									case 'kompetensi': {
											include "kompetensi_tampil.php";
											break;
										}
									...
									case 'inputkognetif': {
											include "rapor_kognetif.php";
											break;
										}
									case 'inputterampil': {
											include "rapor_motorik.php";
											break;
										}
									case 'detailsikap': {
											include "rapor_detsikap.php";
											break;
										}
									case 'detailkognetif': {
											include "rapor_detkognetif.php";
											break;
										}
									case 'detailmotorik': {
									...
									case 'nilaius': {
											include "us_tampil.php";
											break;
										}
									case 'inputus': {
											include "us_input.php";
											break;
										}
									case 'nilaiijz': {
		...
		<script type="text/javascript">
			...
			$("#cetak").click(function(e) {
				...
				if (id == 'binduk') {
					...
					myurl = "cetak_mutasi.php?awal=" + awal + "&akhir=" + akhir;
				}
