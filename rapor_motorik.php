...
<div class="card card-primary card-outline">
    <div class="card-header">
        <h5 class="card-title m-0" id="judul">Input Nilai Keterampilan</h5>
    ...
    <form action="" method="post">
        <div class="card-body">
            <div class="form-group row mt-2 mb-0">
                <div class="col-sm-12">
                    <label>Pilih Kelas dan Tahun Pelajaran</label>
                </div>
            </div>
            <div class="form-group row mt-2 mb-4">
                ...
                <div class="col-sm-3">
                    ...
                    <button type="submit" class="btn btn-info col-6 mt-0 ml-2" id="simpan" name="motorik">
                        <i class="fas fa-save">
                        </i>
                        Simpan</button>
                </div>
