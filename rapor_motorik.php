...
<div class="col-sm-12">
	<div class="card card-primary card-outline">
		<div class="card-header">
			<h5 class="m-0" id="judul">Input Nilai Pengetahuan</h5>
		</div>
        <div class="card-body">
                <div class="col-sm-12">
                        ...
                        <table class="table table-bordered table-condensed table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="form-control txtNilai" name="nilai<?php echo $no;?>" id="nilai<?php echo $no;?>" style="text-align:center;height:42px">
                                    </td>
                                    <td>
                                        <textarea class="form-control txtDeskripsi" name="des<?php echo $no;?>" id="des<?php echo $no;?>" style="height:42px"></textarea>
                                    </td>
                                </tr>
