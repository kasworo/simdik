                ...
                for ($i = 10; $i <= $baris; $i++) {
                    ...
                    for ($j = 1; $j <= $jmp; $j++) {
                        ...
                        if (cekdata('tbnilairapor', $keykog) > 0) {
                            ...
                            if (editdata('tbnilairapor', $nilai, '', $keykog) > 0) {
                                $updkog++;
                            } else {
                                $btlkog++;
                            }
                            ...
                            if (adddata('tbnilairapor', $nilai) > 0) {
                                $skskog++;
                            } else {
                                $gglkog++;
                            }
                        ...
                        if (cekdata('tbnilairapor', $keymot) > 0) {
                            ...
                            if (editdata('tbnilairapor', $nilai, '', $keymot) > 0) {
                                $updmot++;
                            } else {
                                $btlmot++;
                            }
                    ...
                    if (cekdata('tbnilaisikap', $keyspr) > 0) {
                        ...
                        if (editdata('tbnilaisikap', $nilai, '', $keyspr) > 0) {
                            $updspr++;
                        } else {
                            $btlspr++;
                        }
                        ...
                        if (adddata('tbnilaisikap', $sikap) > 0) {
                            $sksspr++;
                        } else {
                            $gglspr++;
                        }
                    ...
                    if (cekdata('tbnilaisikap', $keysos) > 0) {
                        ...
                        if (editdata('tbnilaisikap', $sikap, '', $keysos) > 0) {
                            $updsos++;
                        } else {
                            $btlsos++;
                        }
                    ...
                    if (cekdata('tbabsensi', $keyabs) > 0) {
                        ...
                        if (editdata('tbabsensi', $absen, '', $keyabs) > 0) {
                            $updabs++;
                        } else {
                            $btlabs++;
                        }
                    ...
                    for ($k = 1; $k <= $jeks; $k++) {
                        ...
                        $xnekskul = $data->val($i, ($k - 1) + $jmp * 4 + 12);
                        $xneks = KonversiHuruf(str_replace(" ", "", $xnekskul));
                        if (cekdata('tbnilaiekskul', $keyeks) > 0) {
                            $ekskul = array(
                                'nilaieks' => $xneks
                            );
                            if (editdata('tbnilaiekskul', $ekskul, '', $keyeks) > 0) {
                                $updeks++;
                            } else {
                                $btleks++;
                            }
                            ...
                            if (adddata('tbnilaiekskul', $ekskul) > 0) {
                                $skseks++;
                            } else {
                                $ggleks++;
                            }
                ...
                for ($i = 10; $i <= $baris; $i++) {
                    ...
                    for ($j = 1; $j <= $jmp; $j++) {
                        ...
                        if (cekdata('tbnilaius', $keyust) > 0) {
                            ...
                            if (editdata('tbnilaus', $nilai, '', $keyust) > 0) {
                                $updust++;
                            } else {
                                $btlust++;
                            }
                        ...
                        if (cekdata('tbnilaius', $keyusp) > 0) {
                            ...
                            if (editdata('tbnilaus', $nilai, '', $keyusp) > 0) {
                                $updusp++;
                            } else {
                                $btlusp++;
                            }
                ...
                for ($i = 10; $i <= $baris; $i++) {
                    ...
                    for ($j = 1; $j <= $jmp; $j++) {
                        ...
                        if (cekdata('tbnilaiijz', $keyijz) > 0) {
                            ...
                            if (editdata('tbnilijz', $nilai, '', $keyijz) > 0) {
                                $updijz++;
                            } else {
                                $btlijz++;
                            }
        ...
        <div class="form-group row mt-2 mb-4">
            <div class="col-sm-3">
                <select class="form-control input-sm" id="txtKls">
                    ...
                    <?php
                    $sql = "SELECT idkelas, nmkelas FROM tbkelas INNER JOIN tbskul USING(idjenjang)";
                    $qkls = vquery($sql);
                    foreach ($qkls as $kl) :
                    ?>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center">
                            <form action="rapor_template.php" method="post">
                                ...
                                <button type="submit" class="btn btn-xs btn-success tmpinput" name="downrpt" id="downrpt" disabled="disabled">
                                    <i class="fas fa-cloud-download-alt"></i>&nbsp;Download
                                </button>
                                <a href="#" class="btn btn-xs btn-info tmpimport" name="uplrpt" id="uplrpt" disabled="disabled" data-toggle="modal" data-target="#myRapor" data-id="1">
                    ...
                    <tr>
                        ...
                        <td style="text-align:center">
                            <form action="rapor_template.php" method="post">
                                ...
                                <button type="submit" class="btn btn-xs btn-success tmpinput" name="downuas" id="downuas" disabled="disabled">
                                    <i class="fas fa-cloud-download-alt"></i>&nbsp;Download
                                </button>
                                <a href="#" class="btn btn-xs btn-info tmpimport" name="upluas" id="upluas" disabled="disabled" data-toggle="modal" data-target="#myRapor" data-id="2">
                                    <i class="fas fa-cloud-upload-alt"></i>&nbsp;Import
                                </a>
                            </form>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center">
                            <form action="rapor_template.php" method="post">
                                ...
                                <button type="submit" class="btn btn-xs btn-success tmpinput" name="downijz" id="downijz" disabled="disabled">
                                    <i class="fas fa-cloud-download-alt"></i>&nbsp;Download
                                </button>
                                <a href="#" class="btn btn-xs btn-info tmpimport" name="uplijz" id="uplizj" disabled="disabled" data-toggle="modal" data-target="#myRapor" data-id="3">
                                    <i class="fas fa-cloud-upload-alt"></i>&nbsp;Import
                                </a>
                            </form>
                        </td>
