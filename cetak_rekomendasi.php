...
class PDF extends FPDF
{
	...
	function IsiSurat()
	{
		...
		$this->Cell(0.25, 0.575, ':');
		$this->Ln(0.74);
		$this->MultiCell(19, 0.575, 'Bahwa peserta didik di atas dapat diterima di kelas IX (Sembilan), dengan ketentuan menyerahkan:
		1.	Raport atas nama yang bersangkutan
		2.	Bukti mutasi dari Data Pokok Pendidikan (Dapodik) atau Education Management Information System (EMIS), contoh terlampir.
		3.	Fotokopi Ijazah SD/MI
		4.	Fotokopi Akte Kelahiran
		5.	Fotokopi Kartu Keluarga
		Demikian surat rekomendasi ini dibuat dan diberikan kepada yang bersangkutan, untuk dapat dipergunakan sebagaimana mestinya.
		', 0, 'J');
	}
